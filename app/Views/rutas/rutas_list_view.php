            ...
            <table id="data-table" class="table table-hover w-100 dataTable no-footer">
                <thead>
                    <tr role="row">
                        ...
                        <th class="text-center">Efectivo Ruta(efectivo+deposito)</th>
                        <th class="text-center">Gastos Ruta</th>
                    ...
                    <?php if (!empty($rutas)) : $count = 1; ?>
                        <?php foreach ($rutas as $ruta) : $count++; ?>
                            <tr>
                                ...
                                <td class="text-center"><?= !empty($ruta->gastos_ruta) ? $ruta->gastos_ruta : 'Sin Información' ?></td>
