 ...
 <nav class="navbar ms-navbar">
   ...
   <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
     <li class="ms-nav-item dropdown">
       <a href="#" id="rutasDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-route fa-2x pr-2"></i> Rutas</a>
       <ul class="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="rutasDropdown">
         <li class="dropdown-menu-footer">
           <a class="media fs-14 p-2" href="<?= base_url('rutas/nuevo') ?>"> <span><i class="fa fa-plus-circle pr-2" aria-hidden="true"></i> Nueva Ruta</span> </a>
           <a class="media fs-14 p-2" href="<?= base_url('rutas/listado') ?>"> <span><i class="fas fa-list pr-2"></i> Listado Rutas</span> </a>
         </li>
       </ul>
     </li>
     <li class="ms-nav-item dropdown">
       <a href="#" id="ventasDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-hand-holding-usd pr-2" style="font-size: 26px;"></i> Ventas</a>
     ...
     <li class="ms-nav-item dropdown">
       <a href="#" id="clientesDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-users pr-2" style="font-size: 26px;"></i> Clientes</a>
     ...
     <li class="ms-nav-item">
       <a href="<?= base_url('logout') ?>"><i class="fas fa-door-open pr-2" style="font-size: 26px;"></i> Cerrar Sesion</a>
     </li>
     <!-- 
