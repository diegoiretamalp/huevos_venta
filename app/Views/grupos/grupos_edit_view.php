                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingrese Nombre..." value="<?= !empty($errores) ? $errores['nombre'] : (!empty($grupo->nombre) ? $grupo->nombre : '') ?>">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table" id="table_clientes">
                                ...
                                <tbody id="table_clientes_tbody">
                                    <!-- <?php if (!empty($clientes_grupo)) : $count = 0 ?>
                                        <?php foreach ($clientes_grupo as $cliente) : $count++ ?>
                                            <tr>
                                                <td><?= $count ?></td>
                                                <td><?= !empty($cliente->nombre) ? $cliente->nombre : 'Sin Información' ?></td>
                                                <td><?= !empty($cliente->direccion) ? $cliente->direccion : 'Sin Información' ?></td>
                                                <td><?= !empty($cliente->contacto) ? $cliente->contacto : 'Sin Información' ?></td>
                                                <td>
                                                    <a ></a>
                                                </td>
                                            </tr>
