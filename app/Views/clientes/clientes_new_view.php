    ...
    <div class="row">
        ...
        <div class="col-12">
            <form action="<?= isset($action) ? $action : '' ?>" method="post">
                        ...
                        <div class="input-group">
                            <select name="sector_id" id="sector_id" class="form-control">
                                ...
                                <?php foreach ($sectores as $sector) : ?>
                                    <option <?= !empty($errores) ? ($errores['sector_id'] == $sector->id ? 'selected' : '') : (!empty($post) ? ($post['sector_id'] == $sector->id ? 'selected' : '') : '') ?> value="<?= $sector->id ?>"><?= $sector->nombre ?></option>
                                <?php endforeach; ?>
                            </select>
                ...
                <button class="btn btn-primary mt-4 d-block w-100" type="submit">Crear Cliente</button>
            </form>
        </div>
    </div>
</div>