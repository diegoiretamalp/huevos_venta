...
defined('BASE_URL') || define('BASE_URL', $base_host);


define('BASE_HOST',         $base_host);
define("ASSETS",            BASE_HOST . 'assets/');
define("ASSETS_IMG",            BASE_HOST . 'assets/img/');
define("ASSETS_CSS",            BASE_HOST . 'assets/css/');
define("ASSETS_ICONS",            BASE_HOST . 'assets/icons/');
define("ASSETS_JS",            BASE_HOST . 'assets/js/');
define("ASSETS_VENDOR",            BASE_HOST . 'vendor/');
define("ASSETS_PLUGINS",            BASE_HOST . 'assets/plugins/');
